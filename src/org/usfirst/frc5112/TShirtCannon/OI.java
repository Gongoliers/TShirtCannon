...
public class OI {
	...
	public OI() {
		...
		SmartDashboard.putData("Enable Cannon Stop", new EnableCannonStop());
		...
		SmartDashboard.putData("Disable Cannon Stop", new DisableCannonStop());
	...
	public Joystick getTurretStick() {
		return turretStick;
	}
